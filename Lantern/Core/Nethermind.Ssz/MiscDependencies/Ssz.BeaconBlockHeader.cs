...
namespace Nethermind.Ssz
{
    public static partial class Ssz
    {
        ...
        public static void Encode(Span<byte> span, BeaconBlockHeader container)
        {
            ...
            Encode(span, new Root(((ReadOnlySpan<byte>)container.ParentRoot)), ref offset);
            Encode(span, new Root(((ReadOnlySpan<byte>)container.StateRoot)), ref offset);
            Encode(span, new Root(((ReadOnlySpan<byte>)container.BodyRoot)), ref offset);
        }
        ...
        public static BeaconBlockHeader DecodeBeaconBlockHeader(ReadOnlySpan<byte> span)
        {
            ...
            BeaconBlockHeader container = new BeaconBlockHeader(slot, ValidatorIndex.Zero,new Root(((ReadOnlySpan<byte>)parentRoot)), new Root(((ReadOnlySpan<byte>)stateRoot)), new Root(((ReadOnlySpan<byte>)bodyRoot)));
            return container;
        }
    }
}