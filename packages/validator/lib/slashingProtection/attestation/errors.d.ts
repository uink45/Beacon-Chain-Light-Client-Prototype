...
export declare enum InvalidAttestationErrorCode {
    /**
...
declare type InvalidAttestationErrorType = {
...
export declare class InvalidAttestationError extends LodestarError<InvalidAttestationErrorType> {
