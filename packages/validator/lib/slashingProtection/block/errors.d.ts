...
export declare enum InvalidBlockErrorCode {
    /**
...
declare type InvalidBlockErrorType = {
...
export declare class InvalidBlockError extends LodestarError<InvalidBlockErrorType> {
