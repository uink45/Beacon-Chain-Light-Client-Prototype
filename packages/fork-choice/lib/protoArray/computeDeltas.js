 ...
 */
function computeDeltas(indices, votes, oldBalances, newBalances) {
    const deltas = Array.from({ length: indices.size }, () => 0);
    const zeroHash = interface_1.HEX_ZERO_HASH;
...
exports.computeDeltas = computeDeltas;
