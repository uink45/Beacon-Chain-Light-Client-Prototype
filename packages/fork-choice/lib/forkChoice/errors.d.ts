...
export declare type InvalidBlock = {
    ...
    blockAncestor?: RootHex;
};
export declare enum InvalidAttestationCode {
    /**
...
export declare type InvalidAttestation = {
...
export declare type ForkChoiceErrorType = {
    ...
    code: ForkChoiceErrorCode.PROTO_ARRAY_ERROR;
    err: string;
} | {
    code: ForkChoiceErrorCode.INVALID_PROTO_ARRAY_BYTES;
    err: string;
} | {
    ...
    code: ForkChoiceErrorCode.FORK_CHOICE_STORE_ERROR;
    error: Error;
} | {
