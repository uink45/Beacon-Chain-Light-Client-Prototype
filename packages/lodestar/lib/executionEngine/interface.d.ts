...
export declare enum ExecutePayloadStatus {
...
export declare type ExecutePayloadResponse = {
    status: ExecutePayloadStatus.SYNCING | ExecutePayloadStatus.ACCEPTED;
    ...
    status: ExecutePayloadStatus.INVALID;
    latestValidHash: RootHex;
    validationError: string | null;
} | {
    status: ExecutePayloadStatus.INVALID_BLOCK_HASH | ExecutePayloadStatus.INVALID_TERMINAL_BLOCK | ExecutePayloadStatus.ELERROR | ExecutePayloadStatus.UNAVAILABLE;
    latestValidHash: null;
    validationError: string;
};
export declare type ForkChoiceUpdateStatus = ExecutePayloadStatus.VALID | ExecutePayloadStatus.INVALID | ExecutePayloadStatus.SYNCING | ExecutePayloadStatus.INVALID_TERMINAL_BLOCK;
export declare type PayloadAttributes = {
    timestamp: number;
    prevRandao: Uint8Array | ByteVector;
    suggestedFeeRecipient: Uint8Array | ByteVector;
};
export declare type ApiPayloadAttributes = {
