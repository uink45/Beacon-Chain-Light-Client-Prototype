...
export declare type EthJsonRpcBlockRaw = {
...
export declare type Eth1DataAndDeposits = {
...
export declare type Eth1Block = {
    blockHash: Uint8Array;
    blockNumber: number;
    timestamp: number;
};
export declare type PowMergeBlock = {
    number: number;
    blockhash: RootHex;
    parentHash: RootHex;
...
export declare type IEth1StreamParams = Pick<IBeaconConfig, "ETH1_FOLLOW_DISTANCE" | "MIN_GENESIS_TIME" | "GENESIS_DELAY" | "SECONDS_PER_ETH1_BLOCK"> & {
    maxBlocksPerPoll: number;
};
export declare type IJson = string | number | boolean | undefined | IJson[] | {
    [key: string]: IJson;
};
