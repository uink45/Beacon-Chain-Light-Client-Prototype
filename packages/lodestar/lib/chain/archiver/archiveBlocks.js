...
exports.getNonCheckpointBlocks = exports.getParentRootFromSignedBlock = exports.archiveBlocks = void 0;
 ...
 */
async function archiveBlocks(db, forkChoice, lightclientServer, logger, finalizedCheckpoint) {
    ...
    const finalizedCanonicalBlockRoots = finalizedCanonicalBlocks.map((block) => ({
        slot: block.slot,
        root: (0, ssz_1.fromHexString)(block.blockRoot),
    }));
    ...
    const nonCanonicalBlockRoots = finalizedNonCanonicalBlocks.map((summary) => (0, ssz_1.fromHexString)(summary.blockRoot));
...
exports.archiveBlocks = archiveBlocks;
 ...
 * To byte: `116 + 32 = 148`
 */
function getParentRootFromSignedBlock(bytes) {
    return bytes.slice(116, 148);
}
exports.getParentRootFromSignedBlock = getParentRootFromSignedBlock;
/**
 *
 ...
 */
function getNonCheckpointBlocks(blocks) {
    ...
    for (let i = blocks.length - 1; i >= 0; i--) {
        ...
        if (block.slot % lodestar_params_1.SLOTS_PER_EPOCH === 0) {
...
exports.getNonCheckpointBlocks = getNonCheckpointBlocks;
