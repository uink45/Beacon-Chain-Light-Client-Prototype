...
export declare type AttestationErrorType = {
    ...
    code: AttestationErrorCode.AGGREGATOR_PUBKEY_UNKNOWN;
    ...
    code: AttestationErrorCode.AGGREGATOR_INDEX_TOO_HIGH;
    aggregatorIndex: ValidatorIndex;
} | {
    ...
    code: AttestationErrorCode.PRIOR_ATTESTATION_KNOWN;
...
export declare class AttestationError extends GossipActionError<AttestationErrorType> {
    getMetadata(): Record<string, string | number | null>;
}
//# sourceMappingURL=attestationError.d.ts.map