...
declare type ExecutionErrorStatus = Exclude<ExecutePayloadStatus, ExecutePayloadStatus.VALID | ExecutePayloadStatus.ACCEPTED | ExecutePayloadStatus.SYNCING>;
export declare type BlockErrorType = {
    ...
    code: BlockErrorCode.NOT_FINALIZED_DESCENDANT;
    parentRoot: RootHex;
} | {
    ...
    execStatus: ExecutionErrorStatus;
    errorMessage: string;
};
export declare class BlockGossipError extends GossipActionError<BlockErrorType> {
}
export declare class BlockError extends LodestarError<BlockErrorType> {
    readonly signedBlock: allForks.SignedBeaconBlock;
    constructor(signedBlock: allForks.SignedBeaconBlock, type: BlockErrorType);
    getMetadata(): Record<string, string | number | null>;
}
export declare class ChainSegmentError extends LodestarError<BlockErrorType> {
    readonly signedBlock: allForks.SignedBeaconBlock;
    /**
     * Number of blocks successfully imported before the error
     */
    importedBlocks: number;
    constructor(signedBlock: allForks.SignedBeaconBlock, type: BlockErrorType, importedBlocks: number);
    getMetadata(): Record<string, string | number | null>;
}
export declare function renderBlockErrorType(type: BlockErrorType): Record<string, string | number | null>;
export {};
//# sourceMappingURL=blockError.d.ts.map