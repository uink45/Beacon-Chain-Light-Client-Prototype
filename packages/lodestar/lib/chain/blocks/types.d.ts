...
export declare type FullyVerifiedBlockFlags = {
    /**
...
export declare type PartiallyVerifiedBlockFlags = FullyVerifiedBlockFlags & {
    /**
 ...
 */
export declare type FullyVerifiedBlock = FullyVerifiedBlockFlags & {
 ...
 */
export declare type PartiallyVerifiedBlock = PartiallyVerifiedBlockFlags & {
    block: allForks.SignedBeaconBlock;
};
