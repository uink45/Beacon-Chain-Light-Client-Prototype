 ...
 * ```
 */
export declare type SyncCommitteeWitness = {
    /** Vector[Bytes32, 4] */
    witness: Uint8Array[];
    currentSyncCommitteeRoot: Uint8Array;
    nextSyncCommitteeRoot: Uint8Array;
};
export declare type PartialLightClientUpdateFinalized = {
    isFinalized: true;
...
export declare type PartialLightClientUpdateNonFinalized = {
    isFinalized: false;
    attestedHeader: phase0.BeaconBlockHeader;
    /** Precomputed root to prevent re-hashing */
    blockRoot: Uint8Array;
...
export declare type PartialLightClientUpdate = PartialLightClientUpdateFinalized | PartialLightClientUpdateNonFinalized;
