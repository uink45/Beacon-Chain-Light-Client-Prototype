 ...
 */
export declare enum InsertOutcome {
...
export declare enum OpPoolErrorCode {
...
export declare type OpPoolErrorType = {
    code: OpPoolErrorCode.SLOT_TOO_LOW;
    slot: Slot;
    lowestPermissibleSlot: Slot;
} | {
    code: OpPoolErrorCode.REACHED_MAX_PER_SLOT;
};
export declare class OpPoolError extends LodestarError<OpPoolErrorType> {
}
