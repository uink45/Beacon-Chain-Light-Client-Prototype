 ...
 */
export declare enum ChainEvent {
    /**
...
declare const ChainEventEmitter_base: new () => StrictEventEmitter<EventEmitter, IChainEvents>;
/**
 ...
 * - Checkpointing: the chain processes epoch boundaries
 */
export declare class ChainEventEmitter extends ChainEventEmitter_base {
}
export {};
