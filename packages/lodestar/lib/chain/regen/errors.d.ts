...
export declare enum RegenErrorCode {
...
export declare type RegenErrorType = {
    code: RegenErrorCode.BLOCK_NOT_IN_FORKCHOICE;
    blockRoot: RootHex | Root;
} | {
    code: RegenErrorCode.STATE_NOT_IN_FORKCHOICE;
    stateRoot: RootHex | Root;
} | {
...
export declare class RegenError extends Error {
    type: RegenErrorType;
