...
export declare enum SszSnappyErrorCode {
...
declare type SszSnappyErrorType = {
...
export declare class SszSnappyError extends LodestarError<SszSnappyErrorType> {
