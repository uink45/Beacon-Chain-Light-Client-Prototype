...
export declare const PARALLEL_HEAD_CHAINS = 2;
...
export declare const BATCH_SLOT_OFFSET = 1;
/** First epoch to allow to start gossip  */
export declare const MIN_EPOCH_TO_START_GOSSIP = -1;
/**
 ...
 * bandwidth to do so.
 */
export declare const EPOCHS_PER_BATCH = 2;
/**
 ...
 */
export declare const BATCH_BUFFER_SIZE = 5;
