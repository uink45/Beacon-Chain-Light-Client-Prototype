...
export declare enum BackfillSyncErrorCode {
...
export declare type BackfillSyncErrorType = {
...
export declare class BackfillSyncError extends LodestarError<BackfillSyncErrorType> {
}
