...
exports.createLodestarMetrics = void 0;
/**
 * Extra Lodestar custom metrics
 */
// eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types, @typescript-eslint/explicit-function-return-type
function createLodestarMetrics(register, metadata, anchorState) {
    if (metadata) {
        register.static({
    ...
    return {
        ...
        peersRequestedSubnetsToQuery: register.gauge({
        ...
        peersRequestedSubnetsPeerCount: register.gauge({
        ...
        discovery: {
            ...
            findNodeQueryRequests: register.gauge({
            ...
            discoveredStatus: register.gauge({
        ...
        apiRestResponseTime: register.histogram({
        ...
        validatorMonitor: {
            ...
            prevEpochOnChainInclusionDistance: register.gauge({
            ...
            prevEpochAttestationsTotal: register.gauge({
            ...
            prevEpochAttestationAggregateInclusions: register.gauge({
            ...
            prevEpochAttestationBlockInclusions: register.gauge({
            ...
            prevEpochAttestationBlockMinInclusionDistance: register.gauge({
            ...
            prevEpochBeaconBlocksTotal: register.gauge({
            ...
            prevEpochAggregatesTotal: register.gauge({
...
exports.createLodestarMetrics = createLodestarMetrics;
