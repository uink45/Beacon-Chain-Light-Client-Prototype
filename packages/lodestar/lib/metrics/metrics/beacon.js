...
exports.createBeaconMetrics = void 0;
/**
 * Metrics from:
...
function createBeaconMetrics(register) {
    return {
        ...
        reqRespRateLimitErrors: register.gauge({
...
exports.createBeaconMetrics = createBeaconMetrics;
