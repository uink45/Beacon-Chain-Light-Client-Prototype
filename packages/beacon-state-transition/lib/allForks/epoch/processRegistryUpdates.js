...
exports.processRegistryUpdates = void 0;
 ...
 *   - indicesToEject: 0
 */
function processRegistryUpdates(state, epochProcess) {
    ...
    for (const index of epochProcess.indicesToEject) {
        ...
        (0, block_1.initiateValidatorExit)(state, validators[index]);
    }
    ...
    for (const index of epochProcess.indicesEligibleForActivation.slice(0, epochCtx.churnLimit)) {
        ...
        validator.activationEpoch = (0, util_1.computeActivationExitEpoch)(epochProcess.currentEpoch);
    }
}
exports.processRegistryUpdates = processRegistryUpdates;
//# sourceMappingURL=processRegistryUpdates.js.map