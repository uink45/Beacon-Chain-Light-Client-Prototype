...
exports.processJustificationAndFinalization = void 0;
...
function processJustificationAndFinalization(state, epochProcess) {
    ...
    if (epochProcess.prevEpochUnslashedStake.targetStakeByIncrement * 3 >= epochProcess.totalActiveStakeByIncrement * 2) {
        state.currentJustifiedCheckpoint = {
            epoch: previousEpoch,
            root: (0, util_1.getBlockRoot)(state, previousEpoch),
        };
        bits[1] = true;
    }
    if (epochProcess.currEpochUnslashedTargetStakeByIncrement * 3 >= epochProcess.totalActiveStakeByIncrement * 2) {
        state.currentJustifiedCheckpoint = {
            epoch: currentEpoch,
            root: (0, util_1.getBlockRoot)(state, currentEpoch),
        };
        bits[0] = true;
    }
...
exports.processJustificationAndFinalization = processJustificationAndFinalization;
//# sourceMappingURL=processJustificationAndFinalization.js.map