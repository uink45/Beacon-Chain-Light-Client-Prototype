 ...
 */
export declare type EpochProcess = {
    prevEpoch: Epoch;
    currentEpoch: Epoch;
    /**
...
export declare function beforeProcessEpoch<T extends allForks.BeaconState>(state: CachedBeaconState<T>): EpochProcess;
//# sourceMappingURL=epochProcess.d.ts.map