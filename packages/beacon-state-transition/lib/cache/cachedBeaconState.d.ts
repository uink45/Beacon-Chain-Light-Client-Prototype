...
import { CachedEpochParticipation } from "./cachedEpochParticipation";
...
export declare class BeaconStateContext<T extends allForks.BeaconState> {
     ...
     */
    inactivityScores: CachedInactivityScoreList & List<Number64>;
    constructor(type: ContainerType<T>, tree: Tree, previousEpochParticipationCache: MutableVector<ParticipationFlags>, currentEpochParticipationCache: MutableVector<ParticipationFlags>, inactivityScoresCache: MutableVector<Number64>, epochCtx: EpochContext);
