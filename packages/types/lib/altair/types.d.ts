...
import { Number64, Uint64, ParticipationFlags, Bytes32, BLSSignature, Version, BLSPubkey, Slot, Root, ValidatorIndex, SubcommitteeIndex } from "../primitive/types";
import * as phase0 from "../phase0/types";
export declare type SyncSubnets = BitVector;
...
export interface BeaconState extends Omit<phase0.BeaconState, "previousEpochAttestations" | "currentEpochAttestations"> {
